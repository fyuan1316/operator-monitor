...
type NameSpacedTypedObjectReference struct {
...
type OperatorStatusSpec struct {
	...
	Operator           corev1.TypedLocalObjectReference `json:"operator"`
	CR                 NameSpacedTypedObjectReference   `json:"cr"`
	InstalledNamespace []string                         `json:"installedNamespace,omitempty"`
}
...
type ComponentStatus struct {
	NameSpacedTypedObjectReference `json:",inline"`
